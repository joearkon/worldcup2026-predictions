...
M.append(dict(
 ...
 score="3 : 0",score_label="最可能比分（次选 3-1 塞）· 塞内加尔胜",win="胜负：塞内加尔胜（须大胜刷净胜球）",
 ...
 win_rel='<b style="color:#e8b84b">主=塞内加尔胜(3-0)</b>——打会漏鱼腩+须大胜动机;<b>次=3-1塞</b>，伊会漏偷1球但塞仍大胜(呼应O/U3.5)。',
 ...
 bars=[("3-0 塞内加尔","mid",100,"18"),("3-1 塞内加尔","",90,"15"),("2-0 塞内加尔","",80,"13"),("4-0 塞内加尔","",64,"11"),("1-0/平 偷分","alt",34,"6")],
 ...
 verdict_body='<p><b>胜负关系</b>：<b style="color:#e8b84b">主=塞内加尔胜(3-0)</b>——打会漏鱼腩伊拉克+须大胜动机,按"对会漏队往上够"押大净胜(亚盘-2/O/U3.5印证);<b>次=3-1塞</b>——伊会漏偷1球但塞仍大胜。</p><p><b>比分锚</b>：3-0主、3-1次(跨大小球线3.5);胜负无悬念,焦点是净胜球够不够最佳第三。</p>',
...
M.append(dict(
 ...
 score="1 : 0",score_label="最可能比分（次选 1-1 平）· 佛得角胜",win="胜负：佛得角胜（次选：平·佛-0.25退半）",
 ...
 win_rel='<b style="color:#e8b84b">主=佛得角胜(1-0)</b>——沙压上被佛反击偷一球,低分(Under);<b>次=1-1平</b>，佛"逢强逼平"惯性+沙门将救场(佛-0.25退半)。',
 ...
 bars=[("1-0 佛得角","mid",100,"18"),("1-1 平","alt",84,"15"),("0-0 闷平","alt",58,"10"),("2-1 佛得角","",50,"9"),("1-2 沙特","",46,"8")],
 ...
 verdict_body='<p><b>胜负关系</b>：<b style="color:#e8b84b">主=佛得角胜(1-0)</b>——沙特须赢压上→正撞佛得角铁桶+反击,被偷一球;低分符合Under盘+佛画像;<b>次=1-1平</b>——佛连平西/乌的"逢强逼平"惯性+沙门将救场(佛-0.25退半)。</p><p><b>比分锚</b>：1-0主、1-1平次,偏小(Under);胜者基本出线。</p>',
...
M.append(dict(
 ...
 score="0 : 2",score_label="最可能比分（次选 1-1 平）· 西班牙胜",win="胜负：西班牙胜（次选：平·西轮换达成出线）",
 ...
 win_rel='<b style="color:#e8b84b">主=西班牙胜(0-2)</b>——本届最佳防守零封转化差的乌拉圭、乌压上被反击,呼应Opta62.2%+亚盘-1.5;<b>次=1-1平</b>，西轮换留力(不败即可)+乌死拼咬平。',
 ...
 bars=[("0-2 西班牙","mid",100,"19"),("1-1 平","alt",80,"14"),("0-1 西班牙","",78,"13"),("1-2 西班牙","",58,"10"),("0-3 西班牙","",46,"8")],
 bars_note="偏西·O/U 2.5。⇒ 乌压上被反击→1-2主;西留力踢平→1-1次。亚马尔首发打开则0-2/1-3西。｜ 盘口采集 06-26(初盘)",
 k1="🇪🇸 亚马尔（首发=效率开关）",k2="乌压上 vs 西反击",k3="🇪🇸 西班牙轮换幅度",
 verdict_title="胜负=西班牙胜 · 比分 0-2（次选 1-1 平）",
 verdict_body='<p><b>胜负关系</b>：<b style="color:#e8b84b">主=西班牙胜(0-2)</b>——本届最佳防守零封转化差的乌拉圭(两场56射仅1球)、乌须赢压上被西快攻/亚马尔反击,呼应 Opta 62.2%+亚盘-1.5(对应2-0);<b>次=1-1平</b>——西班牙轮换留力(不败即可)+乌主场死拼咬平。</p><p><b>比分锚</b>：0-2西主(零封)、1-1平次;市场主流即西胜乌不进球。</p>',
...
M.append(dict(
 ...
 score="0 : 2",score_label="最可能比分（次选 1-1 平·比爆冷）· 比利时胜",win="胜负：比利时胜（次选：平·比便秘爆冷）",
 ...
 win_rel='<b style="color:#e8b84b">主=比利时胜(0-2)</b>——须赢压上+新会漏+卢卡库首发→零封打开(呼应亚盘-2/BTTS No);<b>次=1-1平</b>，比"控得住攻不破"便秘复发被新韧性逼平。',
 ...
 bars=[("0-2 比利时","mid",100,"17"),("1-1 平(比爆冷)","alt",84,"15"),("0-1 比利时","",80,"14"),("0-0 平","alt",56,"10"),("1-2 比利时","",48,"9")],
 ...
 verdict_body='<p><b>胜负关系</b>：<b style="color:#e8b84b">主=比利时胜(0-2)</b>——须赢压上+新西兰非铁桶会漏+卢卡库首发→比利时零封打开(对会漏队≠对伊朗铁桶·呼应亚盘-2+BTTS No);<b>次=1-1平</b>——比"控得住攻不破"便秘复发、被新西兰不败韧性逼平(本场最大冷门)。</p><p><b>比分锚</b>：0-2主(Under/零封)、1-1平次(便秘爆冷);别押比大胜。</p>',
