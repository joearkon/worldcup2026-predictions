...
const WORLDCUP_DATA = {
  ...
  matches: [
    ...
    },
    {
      ...
      note: "【胜负关系:主=英格兰胜/次=英胜·加咬1·胜者锁出线】英ML约-450(~78%)、平+600、加+1300=中深盘偏英(非极端)。【画像】英格兰=愿对攻不慢热(R1 4-2克·凯恩双响12'就先进=魔咒未现)+防线会丢(被克咬2);加纳=技术流但组织偏钝(本场帕特伊回归或改善)、能守低分(1-0险胜巴拿马)+塞门约/苏雷曼纳速度反击。【⑥维】英4-2克(进攻强·+1) vs 加1-0巴(技术流打铁桶·0)→net+1偏英、与盘口同向=胜负高置信。【checklist#9】加纳=有组织防守(零封巴)但非顶级铁桶→英愿对攻+凯恩火热(近5场9球)应破;英防会丢→次锚给加纳进球档(over)。主2-0英(凯恩破+整体一档之上)、次2-1英(英防会丢+加速度反击咬1)。The One Risk=加纳帕特伊回归收紧死守低分+英前30'破不开→闷成1-0;或英防再漏被加咬成2-1胶着甚至偷平。临场盯萨卡是否首发、拉什福德伤情。"
    },
    {
