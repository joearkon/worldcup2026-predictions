  ...
  matches: [
    {
      ...
      note: "【胜负关系:土耳其胜】圣克拉拉Levi's·近土主场。土ML约+105(微热)、平5/2、巴10/3=浅盘偏土。双双0分·生死战(负者基本出局)→两队都得压上、比一般次轮敞开。土天赋齐整(居莱尔/耶尔德兹/恰尔汗均可用·比首轮强)但⚠️首轮30射0进=便秘典型+怕反击;巴拉圭身体流5后卫+防反、脊柱完整。checklist#1半触发→押土赢但收口:主1-0土(天赋凿开但便秘低分)、次2-1土(生死战敞开·巴防反偷1)、尾部1-1(土便秘复发+巴偷分)。The One Risk=土'30射0进'复刻+压上露身后→巴防反偷1-1/0-1(参考澳零封土)。不押土大胜(便秘+巴非鱼腩)。"
    },
    {
    ...
    },
    {
      ...
      note: "【胜负关系:主=美国胜/次=平】西雅图Lumen Field·美主场。欧赔美1.60(62%)/平4.00/澳5.50,亚盘美让-1(+110)=中浅盘偏美主场。两队均3分、胜者直接出线。⚠️澳近3场全走小2.5球+刚用三中卫铁桶让土耳其30射0进。checklist#7盘口类型别混用(欧赔说62%赢/亚盘让-1说赢1球是中位数)→美小胜非碾压;#1'控得住≠攻得破'半触发(澳=有组织铁桶+反击非鱼腩)→收口一球分差、不押美大胜;#2净胜球往低收别压美-2。美防线场场丢→澳大概率反击偷1(both teams to score)。主2-1美(美比土更直接有速度故给小胜)、次1-1(澳拖死美进攻走小球)。The One Risk=澳铁桶+小球的'控得住≠攻得破'复刻——美70'前凿不开→滑成1-1/1-0甚至被澳反击偷走。临场澳退盘则下修1-1。"
    },
    {
