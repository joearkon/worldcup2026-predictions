...
M.append(dict(
 ...
 score="2 : 1", score_label="最可能比分（次选 1-0 西·零封）", win="胜负：西班牙夺冠（控制+晚段·both score）",
 ...
 win_rel='<b style="color:#e8b84b">主=西班牙夺冠(2-1·控制+晚段·both score)</b>——西控制压制+梅里诺型晚段终结,阿松散后防会漏1球但西质量更高;<b>次=1-0西(零封·复刻2-0法国役)</b>。拖到1-1(120′)→点球是阿的唯一活路(⑦维E.马丁内斯)——见下方 The One Risk。',
...
M.append(dict(
 ...
 score="2 : 1", score_label="最可能比分（次选 2-2·荣誉战开放对攻）", win="胜负：法国胜（姆巴佩终结·both score）",
 ...
 win_rel='<b style="color:#e8b84b">主=法国胜(2-1·姆巴佩终结·both score)</b>——法转换终结力(姆巴佩8球)+英KO防线从未零封,两队都会进;<b>次=2-2(荣誉战开放对攻)</b>。1-2英(英若认真+贝林厄姆carry掀翻)见下方 The One Risk。季军赛动机弱→比分置信本就低。',
